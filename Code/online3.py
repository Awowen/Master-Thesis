...
from controllers3 import freezing_layers, splitted_layers, frozen_with_model, splited_with_model, standard_all, full_distributed, full_freezing, frozen_from_2mvt
...
# frozen_from_4mvt('EEG_net', 'models/EEG_net_Full_Freezing_2mvt_13_channels.h5', big_X_train, big_y_train, big_X_test, big_y_test,
